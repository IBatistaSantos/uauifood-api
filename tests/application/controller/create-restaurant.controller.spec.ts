import { GetByIdRestaurantController } from '@/application/controllers'
...
describe('CreateRestaurantController', () => {
  ...
  let sut: GetByIdRestaurantController
  ...
  beforeEach(() => {
    sut = new GetByIdRestaurantController(createRestaurantService)
  })
